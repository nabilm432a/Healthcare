<?php
    ...
    $sql = "INSERT INTO doctor (name, age, degree, specialization, contact, password) VALUES ('$name', '$age', '$degree', '$spec', '$contact', '$password')";
    ...
    if ($conn->query($sql)) {
            ...
            $message = "Unable to register. Please try again." . $conn->error;
            mysqli_close($conn);
